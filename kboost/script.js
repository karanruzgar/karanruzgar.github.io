...
var insults1 = [
    ...
    "Stop watching levy.",
    "The only thing you can make is finding knight boosts.",
    "You call that a knight boost? More like a knight boob",
    "wtf was that knight boost",
    "That was the worst knight boost I've ever seen"
]
var insults2 = [
    "This guy can't even find an knight boost.",
    "You call that a move?",
    "You don't know what knight boost is?",
...
function control(){
    ...
    console.log(ans)
    if (answer.value.toLowerCase() == ans || answer.value.toLowerCase() == ans.substr(0,4)){
        ...
        state.innerHTML = "False. <a href='https://www.google.com/search?q=knight+boost' target=”_blank”>Google knight boost</a>"
